...
class OrderBook:
    ...
    def top_of_book(self) -> Dict[str, Optional[int]]:
        ...
        bid_quantity = self._yes_orders.get(bid_price) if bid_price is not None else None
...
class OrderBookManager:
    ...
    def update_from_snapshot(self, market_ticker: str, yes_orders: list[tuple[int, int]], no_orders: list[tuple[int, int]]) -> None:
    ...
    def update_from_delta(self, market_ticker: str, price: int, delta: int, side: str) -> None:
